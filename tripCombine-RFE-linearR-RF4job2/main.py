...
def DataProcess(data):
    ...
    trainData = pd.concat([TimeCost,lowSpeedTime,speedMax,speedMin,speedStd,#speedMean,diffSpeedMean,
...
def process():
    ...
    model = ensemble.RandomForestRegressor(n_estimators=4, n_jobs=2)
